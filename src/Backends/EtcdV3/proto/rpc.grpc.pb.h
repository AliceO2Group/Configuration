...
// Based on https://github.com/coreos/etcd/blob/master/etcdserver/etcdserverpb/rpc.proto
//
...
class Lease final {
 public:
  ...
  typedef WithAsyncMethod_LeaseGrant<WithAsyncMethod_LeaseRevoke<WithAsyncMethod_LeaseKeepAlive<WithAsyncMethod_LeaseTimeToLive<Service > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_LeaseGrant<WithStreamedUnaryMethod_LeaseRevoke<WithStreamedUnaryMethod_LeaseTimeToLive<Service > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_LeaseGrant<WithStreamedUnaryMethod_LeaseRevoke<WithStreamedUnaryMethod_LeaseTimeToLive<Service > > > StreamedService;
};
